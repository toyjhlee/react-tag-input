(function (global, factory) {
    ...
    var Tag = (function (_super) {
        ...
        Tag.prototype.render = function () {
            var _a = this.props, value = _a.value, index = _a.index, editable = _a.editable, inputRef = _a.inputRef, validator = _a.validator, update = _a.update, readOnly = _a.readOnly, removeOnBackspace = _a.removeOnBackspace, maxLength = _a.maxLength, spaceRemove = _a.spaceRemove;
            ...
            return (React.createElement("div", { className: classSelectors.tag },
                ...
                editable && (React.createElement(ContentEditable, { value: value, inputRef: inputRef, innerEditableRef: this.innerEditableRef, className: classSelectors.tagContent, change: function (newValue) { return update(index, newValue); }, remove: this.remove, validator: validator, removeOnBackspace: removeOnBackspace, maxLength: maxLength, spaceRemove: spaceRemove })),
